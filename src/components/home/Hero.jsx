          ...
          <div className="w-full md:w-1/2">
            <div className="px-5">
              <h1 className="text-center md:text-left text-[#333333] tracking-wider leading-7 mb-10">
                <span className="font-bold text-2xl">We</span> are more than
                just a place to sip, It's where your taste buds will take a
                trip. Our coffee is made with the finest beans,
                Ethically-sourced and expertly roasted to extremes.
              </h1>

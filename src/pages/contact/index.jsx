    ...
    <>
      ...
      <div className='bg-gray-50'>
        <section className='max-w-7xl mx-auto' style={{ minHeight: 'calc(100vh - var(--const-default-nav-height))' }}>
          <div className='flex flex-col lg:flex-row gap-10 justify-between pt-32'>
            <div className='flex-1 px-3 lg:px-0'>
              ...
              <p className='text-gray-600 text-sm leading-[1.6rem]'>
                Stay connected with us and let your voice be heard. Whether you have questions, need assistance, or just
                want to share your thoughts, we're here to help you every step of the way. Reach out to us and
                experience our commitment to providing exceptional support and service.
              </p>
            </div>

            <div className='lg:w-[35rem] rounded-md bg-white'>

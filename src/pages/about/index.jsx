      ...
      <section className='max-w-7xl mx-auto' style={{ minHeight: 'calc(100vh - var(--const-default-nav-height))' }}>
        <div className=''>
          <div className='md:flex items-center justify-center hidden'>
            <img src='/undraw_moonlight_-5-ksn.svg' alt='About Image' width='600' />
          </div>
          <div className='px-3 md:px-0'>
            ...
            <p className='my-5'>
              ...
              perfection. Our skilled baristas are trained to create an array of specialty coffee beverages, ranging
              from classic espresso-based drinks to unique seasonal creations that will delight your taste buds. Whether
              you're a latte lover, a cappuccino connoisseur, or an adventurous coffee explorer, we have something to
              satisfy every palate.
            </p>

            <p className='my-5'>
              But it's not just about the coffee at [Your Coffee Shop Name]. We are committed to providing outstanding
              customer service and creating a sense of community for our patrons. Our friendly and knowledgeable staff
              are always ready to greet you with a smile and make your visit a memorable one. We believe that a cup of
              coffee is more than just a beverage - it's a catalyst for connection, conversation, and shared moments of
              joy.
            </p>

            <p className='my-5'>
              In addition to our delicious coffee, we also offer a tempting selection of freshly baked pastries and
              delectable treats to complement your coffee experience. Whether you're in need of a quick pick-me-up in
              the morning, a cozy spot for a catch-up with friends, or a quiet corner to curl up with a book, [Your
              Coffee Shop Name] is the perfect destination.
            </p>
